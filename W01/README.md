...
**Head Soccer**의 핵심 메커니즘을 구현한 2인 대전 축구 게임 클론 프로젝트입니다.

* 개발 기간 : 2026.03.09 \~ 2026.03.12
* 개발 인원 : 4명
* 장르 : 스포츠, 축구, 2인 대전
* 사용 기술 : C++, Win32 API, DirectX 11, ImGui, SoLoud



## 게임 소개

이 프로젝트는 두 명의 플레이어가 캐릭터를 선택한 뒤 제한 시간 동안 공을 상대 골대에 넣어 점수를 획득하는 2인 대전 게임입니다.

캐릭터를 선택하고 경기를 시작하세요. 경기 중 강력한 스킬을 사용하여 상대방이 쉽게 막지 못할 공격을 해보세요.
게임은 제한 시간 내 더 많은 골을 넣은 플레이어가 승리합니다.
(결과창의 승패는 Player1을 기준으로 합니다.)

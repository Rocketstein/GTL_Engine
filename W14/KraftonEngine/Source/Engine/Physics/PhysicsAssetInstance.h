...
public:
    ...
    bool AddImpulseToBoneAtLocation(const FName& BoneName, const FVector& Impulse, const FVector& WorldLocation) const;
    bool AddImpulseToBoneAtOffset(const FName& BoneName, const FVector& Impulse, const FVector& LocalOffset) const;

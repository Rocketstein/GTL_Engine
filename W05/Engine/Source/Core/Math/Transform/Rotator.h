...
struct FRotator
{
    ...
    static FRotator MakeFromEuler(const FVector3 &InEulerDegrees) noexcept;
    ...
    FVector3 Vector() const noexcept;
...
inline FRotator operator*(float Scale, const FRotator &Rotator) noexcept { return Rotator * Scale; }

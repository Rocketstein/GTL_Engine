...
namespace Engine::Core::Misc
{
    ...
    FWString FName::ConvertToFWString(const FString &InStr)
    {
        ...
        u_strFromUTF8(nullptr, 0, &TargetCapacity, InStr.c_str(), static_cast<int32>(InStr.size()),
                      &Status);
        ...
        u_strFromUTF8(reinterpret_cast<UChar *>(&OutWStr[0]), TargetCapacity, nullptr,
                      InStr.c_str(), static_cast<int32>(InStr.size()), &Status);
    ...
    FString FName::ConvertToFString(const FWString &InWStr)
    {
        ...
        u_strToUTF8(nullptr, 0, &TargetCapacity, reinterpret_cast<const UChar *>(InWStr.c_str()),
                    static_cast<int32>(InWStr.size()), &Status);

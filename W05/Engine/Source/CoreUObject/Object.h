...
#define DECLARE_RTTI(Cls, ParentCls)                                                               \
  public:                                                                                          \
    ...
    static const char *GetStaticTypeName() { return #Cls; }                                        \
    ...
    void               *operator new(size_t Size) { return UObject::AllocateObject(Size, #Cls); }  \
    void operator delete(void *Pointer, size_t Size) { UObject::FreeObject(Pointer, Size); }
...
#define REGISTER_CLASS(Namespace, Cls)                                                             \
    ...
    {                                                                                              \
        ...
        {                                                                                          \
            Cls##Register()                                                                        \
            {                                                                                      \
                FObjectFactory::RegisterObjectType(Namespace::Cls::GetClass(), []() -> UObject *   \

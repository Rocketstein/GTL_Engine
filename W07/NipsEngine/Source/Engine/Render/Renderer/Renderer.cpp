...
void FRenderer::Create(HWND hWindow)
{
	...
	FResourceManager::Get().LoadComputeShader("Shaders/LightTileDepthMaskCS.hlsl", "main",
		nullptr, "LightTileDepthMaskCS");
}
...
void FRenderer::CreateResources()
{
	...
	Resources.LightTileDepthMask.Create(Device.GetDevice(), sizeof(uint32), 522240, true);
...
void FRenderer::Release()
{
	...
	Resources.LightTileDepthMask.Release();
